...
async def process_hk_hdd(file_path, log_func):
    def log(msg, p=None): log_func(msg, p)

    try:
        log(f"HIKVISION HDD verileri okunuyor...", 10)
        ...
        output_path = generate_premium_excel(df_report, "HIKVISION HDD HATA ANALİZİ", "HIKVISION HDD Veri (1.Yöntem).xlsx", log)
